...
<div class="index people">
  <div class="container">
    <form class="index__header" action="<?php
                                        //redirect to the people page
                                        echo get_permalink(get_page_by_path('news-insights'))
                                        ?>">
      <div class="index__name__input">
        <input id="post-name" name="post-name" type="text" class="input index__input" <?php
      ...
      // printf(count($capabilities_posts->posts));
      ?>
      <div class="select-wrap">
      ...
      <div class="select-wrap">
        <select class="select index__select" name="professors" id="professors">
          ...
          foreach ($professors as $key => $value) {
            $user_login = strtolower($value->user_login);
            $new_user = trim($_GET['professors']);
          ?>
            <option <?php
                    if (isset($_GET['professors']) && $new_user  == trim($user_login)) {
                      echo 'selected';
                    }
                    ?> class="index__option-fld" value="<?php echo $user_login; ?>">
              <?php
    ...
    <div id="news" class="index__wrp">
      <div class="index__news-content">
        ...
        if (isset($_GET['capability']) && $_GET['capability'] != '') {
          ...
          $data = new WP_Query($args);
          //get post id from post object as array
          if ($data->posts) {
            foreach ($data->posts as $key => $value) {
      ...
      <div class="index__filter-links">
        <div class="index__filter-sec">
          ...
          <div class="index__filter-link-sec">
            <a href="<?php echo esc_url(site_url('/news-insights/')) . '#news'; ?>" class="index__filter-link index__filter-link-active">View all</a>
            ...
            <ul>
              ...
              ?>
                <li>
                  ...
                  <ul year-data="<?php echo $year; ?>" class="index__child ">
                    <?php
                    foreach ($months['months'] as $key => $vale) {
                    ?>
                      <li>
                        <a href="<?php echo
                                  get_month_link($year, $key) . '#news'; ?>" class="index__filter-link index__month "><?php echo $wp_locale->get_month($key); ?>
                          <span class="index__post__num">
                            <?php echo $vale; ?>
                          </span>
                        </a>
