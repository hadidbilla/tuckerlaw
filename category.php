...
$slice_content = substr($post_content, 0, 200);
      ...
      <div class="index__news-content">
          ...
          <?php
            ...
            if ($total_pages > 1) {
              ...
              if ($current_page == $total_pages) {
                echo '<span class="people__page-btn people__page-next disabled
                ">Next</span>';
              } else {
        ...
        <div class="index__filter-links">
          <div class="index__filter-sec">
            ...
            $currentUrl = rtrim($currentUrl, '/author');
            $currentUrl = rtrim($currentUrl, '/author/');
          ...
          <div class="index__filter-sec">
            ...
            <div class="index__filter-link-sec">
              <ul>
                ...
                ?>
                  <li>
                    <div href="<?php echo esc_url(site_url('/news-insights/')); ?>" class="index__filter-link  index__year">
