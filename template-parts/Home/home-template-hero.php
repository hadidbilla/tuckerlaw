<div class="hhero">
  ...
  ?>
  <img alt="Home Image" src="<?php echo get_theme_mod("gs_home_hero_img", get_bloginfo("template_directory") . "/assets/images/hero-bg.png"); ?>" alt="Home Image" class="hhero__bg__img" srcset="<?php echo get_theme_mod("gs_home_hero_img", get_bloginfo("template_directory") . "/assets/images/hero-bg.png"); ?> 1920w,
  <?php echo get_theme_mod("gs_home_hero_img", get_bloginfo("template_directory") . "/assets/images/hero-bg.png"); ?> 768w,
  <?php echo get_theme_mod("gs_home_hero_img", get_bloginfo("template_directory") . "/assets/images/hero-bg.png"); ?> 480w" sizes="(max-width: 300px) 100vw, 300px, (max-width: 768px) 100vw, 768px, (max-width: 1920px) 100vw, 1920px" />
  ...
  <div class="hhero__wrp container">
    <div class="hhero__lft" data-acsb-main="true" role="main">
      ...
      <img alt="Home Image" src="<?php echo get_theme_mod("gs_home_hero_img", get_bloginfo("template_directory") . "/assets/images/hero-bg.png"); ?>" alt="" class="hhero__bg__img--res" aria-hidden="true" data- acsb-hidden="true">
      ...
      <div class="hhero__rgt__wrp">
        ...
        <form class="hhero__frm" action="<?php
          ...
          <div class="hhero__frm__inputs">
            <input id="name" name="user-name" type="text" class="hhero__frm__input" placeholder="Name (Ex: John)" data-acsb-navigable="true" data-acsb-now-navigable="true" aria-hidden="false" data-acsb-hidden="false" data-acsb-validation-uuid="name" data-acsb- field-visible="true" aria-required="true" aria-invalid="true" aria-label="Name
...
_
blank" data-acsb-tooltip="New Window" data-acsb-clickable="true" data-acsb-navigable="true" data-acsb-now-navigable="true">
              <span class="acsb-sr-only" data-acsb-sr-only="true" data-acsb-force-visible="true" aria- hidden="false" data-acsb-hidden="false">
